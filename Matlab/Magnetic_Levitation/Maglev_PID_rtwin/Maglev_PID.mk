...
MODEL               = Maglev_PID
MODULES_OBJ         = Maglev_PID_data.obj 
MAKEFILE            = Maglev_PID.mk
...
TID01EQ             = 1
NCSTATES            = 0
BUILDARGS           =  GENERATE_REPORT=0 TMW_EXTMODE_TESTING=0 MODELLIB=Maglev_PIDlib.lib RELATIVE_PATH_TO_ANCHOR=.. MODELREF_TARGET_TYPE=NONE
MULTITASKING        = 0
EXT_MODE            = 1
EXTMODE_TRANSPORT   = 0
EXTMODE_STATIC      = 0
...
# Additional includes
ADD_INCLUDES = &
C:\DOCUME~1\Sagar007\MYDOCU~1\MATLAB\1401EE~2\MAGLEV~2;&
